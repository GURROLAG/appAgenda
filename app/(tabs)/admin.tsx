...
export default function AdminScreen() {
  ...
  if (!esAdmin) {
    return (
      <View style={{ flex: 1, justifyContent: 'center', alignItems: 'center', backgroundColor: colors.background }}>
        ...
        <Text style={{ fontSize: 20, fontWeight: 'bold', marginTop: 16, color: colors.text }}>Acceso denegado</Text>
  ...
  return (
    <View style={{ flex: 1, backgroundColor: colors.background }}>
      ...
      {/* HEADER */}
      <View style={{ backgroundColor: darkMode ? '#1a1a1a' : '#0a0a2e', paddingTop: 50, paddingBottom: 20, paddingHorizontal: 20 }}>
                ...
                <View style={{ flexDirection: 'row', alignItems: 'center', flexWrap: 'wrap', gap: 6 }}>
                  ...
                  {u.uid === usuario?.uid && (
                    <View style={{ backgroundColor: '#e8f4ff', paddingHorizontal: 8, paddingVertical: 2, borderRadius: 10 }}>
                      <Text style={{ color: colors.primary, fontSize: 11, fontWeight: 'bold' }}>Tú</Text>
                    </View>
                  )}
                  {!u.activo && (
                    <View style={{ backgroundColor: '#ffe0e0', paddingHorizontal: 8, paddingVertical: 2, borderRadius: 10 }}>
                      <Text style={{ color: colors.danger, fontSize: 11, fontWeight: 'bold' }}>Inactivo</Text>
                    </View>
                  )}
                </View>
                <Text style={{ color: colors.subtext, fontSize: 13, marginTop: 2 }}>{u.email}</Text>
              </View>
              <View style={{ backgroundColor: u.rol === 'admin' ? colors.primary : colors.input, paddingHorizontal: 10, paddingVertical: 4, borderRadius: 20, borderWidth: 1, borderColor: u.rol === 'admin' ? colors.primary : colors.border }}>
                <Text style={{ color: u.rol === 'admin' ? '#fff' : colors.subtext, fontSize: 12, fontWeight: 'bold' }}>
              ...
              <View style={{ gap: 8 }}>
                <View style={{ flexDirection: 'row', gap: 8 }}>
                  <TouchableOpacity onPress={() => cambiarRol(u)} style={{ flex: 1, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', backgroundColor: u.rol === 'admin' ? '#fff3e0' : '#e8f4ff', paddingVertical: 10, borderRadius: 10, gap: 6, borderWidth: 1, borderColor: u.rol === 'admin' ? '#ffa500' : colors.primary }}>
                    ...
                    <Text style={{ color: u.rol === 'admin' ? '#ffa500' : colors.primary, fontWeight: 'bold', fontSize: 12 }}>
                  ...
                  <TouchableOpacity onPress={() => cambiarEstado(u)} style={{ flex: 1, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', backgroundColor: u.activo ? '#fff0f0' : '#f0fff0', paddingVertical: 10, borderRadius: 10, gap: 6, borderWidth: 1, borderColor: u.activo ? colors.danger : '#32cd32' }}>
                    ...
                    <Text style={{ color: u.activo ? colors.danger : '#32cd32', fontWeight: 'bold', fontSize: 12 }}>
                ...
                <View style={{ flexDirection: 'row', gap: 8 }}>
                  <TouchableOpacity onPress={() => abrirEditar(u)} style={{ flex: 1, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', backgroundColor: colors.input, paddingVertical: 10, borderRadius: 10, gap: 6, borderWidth: 1, borderColor: colors.border }}>
                    ...
                    <Text style={{ color: colors.text, fontWeight: 'bold', fontSize: 12 }}>Editar</Text>
                  </TouchableOpacity>
                  <TouchableOpacity onPress={() => restablecerPassword(u)} style={{ flex: 1, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', backgroundColor: '#fff3e0', paddingVertical: 10, borderRadius: 10, gap: 6, borderWidth: 1, borderColor: '#ffa500' }}>
                    ...
                    <Text style={{ color: '#ffa500', fontWeight: 'bold', fontSize: 12 }}>Restablecer</Text>
                  </TouchableOpacity>
                </View>
                <TouchableOpacity onPress={() => eliminarUsuario(u)} style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'center', backgroundColor: '#fff0f0', paddingVertical: 10, borderRadius: 10, gap: 6, borderWidth: 1, borderColor: colors.danger }}>
                  ...
                  <Text style={{ color: colors.danger, fontWeight: 'bold', fontSize: 12 }}>Eliminar usuario</Text>
                </TouchableOpacity>
              </View>
            )}
          </View>
        ...
        <KeyboardAvoidingView behavior={Platform.OS === 'ios' ? 'padding' : 'height'} style={{ flex: 1 }}>
          <View style={{ flex: 1, justifyContent: 'flex-end', backgroundColor: colors.overlay }}>
            <View style={{ backgroundColor: colors.card, borderTopLeftRadius: 25, borderTopRightRadius: 25, padding: 24 }}>
              ...
              <Text style={{ fontSize: 20, fontWeight: 'bold', color: colors.text, marginBottom: 20 }}>✏️ Editar usuario</Text>
              <Text style={{ color: colors.subtext, marginBottom: 8, fontSize: 14 }}>Nombre</Text>
              ...
              <Text style={{ color: colors.subtext, marginBottom: 8, fontSize: 14 }}>Correo electrónico</Text>
              ...
              <View style={{ flexDirection: 'row', gap: 12 }}>
                ...
                <Pressable onPress={guardarEdicion} disabled={guardando} style={{ flex: 1, paddingVertical: 16, borderRadius: 14, alignItems: 'center', backgroundColor: colors.primary }}>
